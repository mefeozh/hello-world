...
```mermaid
mindmap
  root((Mehmet Efe Özhan<br>Portfolio))
    1. Unique Projects
      Autodesk Fusion 360 MCP Agent
      VocalRemover Pro (DirectML)
      L2 Orderbook Microstructure (DuckDB)
      METU Underwater Society Web Platform
      Developer & MarkItDown Utilities
    2. General ME Projects
      ME310 Numerical Methods Suite
      ME301 Mechanism Kinematics & Dynamics
      ME302 Vibrations & Vortex-Induced Resonance
      ME303 Sheet Metal Forming & Plasticity
    3. Great ME Projects
      620 kW Helicopter Gearbox (AGMA 2101/2003)
      10 kN Toggle Jaw Crusher Machine Design
      Hydrodynamic Journal Bearing Optimization
      Marine Pipeline Hydraulics (GIS LandXML / Colebrook)
```
